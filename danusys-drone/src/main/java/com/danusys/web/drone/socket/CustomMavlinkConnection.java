 ...
 * </ul>
 */
public class CustomMavlinkConnection {
    /**
    ...
    public static final class Builder {
         ...
         */
        public CustomMavlinkConnection build() {
            return new CustomMavlinkConnection (
     ...
     * @return A builder instance for the specified settings.
     */
    public static CustomMavlinkConnection create(InputStream in, OutputStream out) {
     ...
     */
    public CustomMavlinkMessage next() throws IOException {
        readLock.lock();
        try {
            ...
            while ((packet = reader.next()) != null) {
                ...
                if (messageType != null) {
                    ...
                    if (packet.isMavlink2()) {
                        ...
                        return new CustomMavlink2Message(packet, payload);
                    } else {
                        //noinspection unchecked
                        return new CustomMavlink2Message(packet, payload);
                    }
...
//            return new CustomMavlink2Message(null, null);
        } catch (Exception e) {
            e.printStackTrace();
//            return new CustomMavlink2Message(null, null);
