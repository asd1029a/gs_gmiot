...
public class DroneCommand {
    ...
    private MAVLinkConnection mavLinkConnection = new MAVLinkConnection();
...
//    }
    ...
    public void ARM_DISARM_FUNCTION(int is_armed) throws IOException {
//        new Thread(() -> {
//        System.out.println(is_armed);
...
//        }).start();
    ...
    public void TAKEOFF_FUNCTION(float alt) throws IOException {
//        new Thread(() -> {
...
//        }).start();
    ...
    public void SET_MODE_FUNCTION(int mode_name) throws IOException {
//        new Thread(() -> {
...
//        }).start();
    ...
    public void CHANGE_SPEED_FUNCTION(float speed) throws IOException {
//        new Thread(() -> {
...
//        }).start();
    ...
    public void CHANGE_YAW_FUNCTION(float angle) throws IOException {
//        new Thread(() -> {
...
//        }).start();
    ...
    public void GOTO_FUNCTION(double lat, double lng, float alt) {
//        new Thread(() -> {
...
//        }).start();
    ...
    public void SERVO_FUNCTION(int pin, int PWM) throws IOException {
//        new Thread(() -> {
