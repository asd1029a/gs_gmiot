...
//    private final Handler mHandler = MainActivity.mHandler;
    ...
    public void MessageClassify(MavlinkMessage message){
...
//                log.info("201", str_arm_disarm);
//                log.info("200", flight_mode);
                log.info("Drone_Message {}", "HEARTBEAT: " + mav_type + " " + mav_autopilot + " " + flight_mode + " " + system_status + " " + arm_disarm);
...
//            Log.i("Drone_Message", "GLOBAL_POSITION_INT: " + lat + " " + lng + " " + alt + " " + relative_alt + " " + heading);
            log.info("Drone_Message {}", "GLOBAL_POSITION_INT: " + lat + " " + lng + " " + alt + " " + relative_alt + " " + heading);
        }
        // SYS_STATUS ( #1 )
...
//            mHandler.obtainMessage(204, volt + " V, " + current + " A, " + percentage +" %").sendToTarget();
            log.info("Drone_Message {}", "SYS_STATUS: " + volt + " " + current + " " + percentage);
...
//            mHandler.obtainMessage(203, air_speed + " m/s ").sendToTarget();
            log.info("Drone_Message {}", "VFR_HUD: " + air_speed + " " + gnd_speed);
        }
        // ATTITUDE ( #30 )
            ...
            log.info("Drone_Message {}", "ATTITUDE: " + roll + " " + pitch + " " + yaw);
        ...
        // GPS_RAW_INT ( #24 )
            ...
            log.info("Drone_Message {}", "GPS_RAW_INT: " + fixType + " " + eph + " " + epv + " " + cog + " " + satellitesVisible);
        }
        // COMMAND_ACK ( #77 )
            ...
            log.info("Drone_Message {}", "COMMAND_ACK: "+ what_cmd + " " + cmd_result);
...
//            mHandler.obtainMessage(301, timestamp + cmd_result).sendToTarget();
        ...
        // STATUSTEXT ( #256 )
            ...
            log.info("Drone_Message {}", "APM_TEXT: " + status_txt);
        }
        // MISSION_ACK ( #47 )
...
//            mHandler.obtainMessage(301, timestamp + mission_result).sendToTarget();
            ...
            log.info("Drone_Message {}", "MissionAck: " + mission_result);
        }
        else{
//            log.info("Drone_Message {}", "Exception: " + message.toString());
        }
    }
