...
public class Flight {
    ...
    public HashMap<String, MissionItemInt> missionTakeoff() {
        ...
        try {
            ...
            connection.send2(systemId, componentId, new CommandLong.Builder().command(MavCmd.MAV_CMD_NAV_TAKEOFF).param1(15).param2(0).param3(0).param4(0).param5(0).param6(0).param7(50).build(), linkId, timestamp, secretKey);
...
//        try {
        ...
        try {
            ...
            while ((message = connection.next()) != null) {
                ...
                if (message2.getPayload().getClass().getName().contains("SysStatus") ||//battery voltage배터리  //battery_remaining 배터리
                        ...
                        message2.getPayload().getClass().getName().contains("EscTelemetry1To4"))//EscTelemetry1To4{temperature=[B@553a3d88, voltage=[0, 0, 0, 0], current=[0, 0,
                {
                } else if (message2.getPayload().getClass().getName().contains("GlobalPositionInt") || message2.getPayload().getClass().getName().contains("NavControllerOutput") || message2.getPayload().getClass().getName().contains("Attitude")) {
    ...
    public String camera() {
        ...
        try {
            ...
            connection.send2(systemId, componentId, new CommandLong.Builder().command(MavCmd.MAV_CMD_SET_CAMERA_MODE).param1(0).param2(1)
//                    .param3(0)
//                    .param4(0)
//                    .param7(0)
                    .build(), linkId, timestamp, secretKey);

            connection.send2(systemId, componentId, new CommandLong.Builder().command(MavCmd.MAV_CMD_DO_CONTROL_VIDEO).param1(-1)     //all camera
