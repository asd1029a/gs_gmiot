        ...
        try {
            ...
            while ((message = connection.next()) != null) {
                ...
                if (message.getPayload() instanceof HomePosition) {
                    ...
                    MissionItemInt missionItemInt0 = new MissionItemInt.Builder().command(MavCmd.MAV_CMD_NAV_WAYPOINT).param1(0).param2(0).param3(0).param4(0).x(latitude).y(longitude).z(altitude).seq(0).targetComponent(0).targetSystem(0).current(0).autocontinue(1).frame(MavFrame.MAV_FRAME_GLOBAL_INT).missionType(MavMissionType.MAV_MISSION_TYPE_MISSION)
            ...
            while ((message = connection.next()) != null) {
                ...
                if (message2.getPayload().getClass().getName().contains("SysStatus") ||//battery voltage배터리  //battery_remaining 배터리
                        ...
                        message2.getPayload().getClass().getName().contains("GlobalPositionInt") || message2.getPayload().getClass().getName().contains("SensorOffsets") || message2.getPayload().getClass().getName().contains("MissionCurrent") || //payload=MissionCurrent{seq=0}
                        ...
                        message2.getPayload().getClass().getName().contains("SystemTime") || message2.getPayload().getClass().getName().contains("LocalPositionNed") || //LocalPositionNed{timeBootMs=12024498, x=-0.07747139, y=0.061710242, z=0.001238235, vx=-0.013305673, vy=-1.9261298E-4, vz=4.191259E-4}}
                        ...
                        message2.getPayload().getClass().getName().contains("EscTelemetry1To4"))//EscTelemetry1To4{temperature=[B@553a3d88, voltage=[0, 0, 0, 0], current=[0, 0,
                {
                    ...
                    log.info("{}={}", message.getPayload().getClass().getName(), message.getPayload());
...
//                   .build(), linkId, timestamp, secretKey);
            ...
            connection.send2(systemId, componentId, new MissionItem.Builder().command(MavCmd.MAV_CMD_NAV_WAYPOINT).targetSystem(0).targetComponent(0).seq(0).current(2).autocontinue(1).frame(MavFrame.MAV_FRAME_GLOBAL_INT).x(x)
                    //37.445521894457784f
                    .y(y)
                    //126.89555727255802f
                    .z(z).build(), linkId, timestamp, secretKey);
...
//        try {
        ...
        try {
            ...
            while ((message = connection.next()) != null) {
                if (message.getPayload() instanceof Heartbeat) {
                    log.info("{}", message);
                } else if (message.getPayload().getClass().getName().contains("GlobalPositionInt")) {
    ...
    public String holdDrone() {
        ...
        try {
            ...
            connection.send2(systemId, componentId, new CommandLong.Builder().command(MavCmd.MAV_CMD_DO_SET_MODE).param1(1).param2(3).build(), linkId, timestamp, secretKey);


            connection.send2(systemId, componentId, new CommandLong.Builder().command(MavCmd.MAV_CMD_DO_PAUSE_CONTINUE).param1(0)
    ...
    public String doMission(HashMap<String, MissionItemInt> missionItemMap, int maxFlag) {
        ...
        try {
            ...
            MavlinkMessage message;
            SystemTime systemTime = SystemTime.builder().build();
            log.info("여기인가요1");
            ...
            while ((message = connection.next()) != null) {
              ...
              //  log.info("messageCount");
                ...
                if (message2.getPayload().getClass().getName().contains("SysStatus") ||//battery voltage배터리  //battery_remaining 배터리
                        message2.getPayload().getClass().getName().contains("PowerStatus") || //payload=PowerStatus{vcc=5000, vservo=0, flags=EnumValue{value=0, entry=null}}}
                        message2.getPayload().getClass().getName().contains("SensorOffsets") || message2.getPayload().getClass().getName().contains("MissionCurrent") || //payload=MissionCurrent{seq=0}
                        message2.getPayload().getClass().getName().contains("ServoOutputRaw") || //ServoOutputRaw{timeUsec=2772547204, port=0, servo1Raw=1591, servo2Raw=1591, servo3Raw=1590, servo4Raw=1591, servo5Raw=0, servo6Raw=0, servo7Raw=0, servo8Raw=0, servo9Raw=0, servo10Raw=0, servo11Raw=0, servo12Raw=0, servo13Raw=0, servo14Raw=0, servo15Raw=0, servo16Raw=0}
                        message2.getPayload().getClass().getName().contains("RcChannels") || //RcChannels{timeBootMs=2637547, chancount=16, chan1Raw=1500, chan2Raw=1500, chan3Raw=1000, chan4Raw=1500, chan5Raw=1800, chan6Raw=1000, chan7Raw=1000, chan8Raw=1800, chan9Raw=0, chan10Raw=0, chan11Raw=0, chan12Raw=0, chan13Raw=0, chan14Raw=0, chan15Raw=0, chan16Raw=0, chan17Raw=0, chan18Raw=0, rssi=255}}
                        message2.getPayload().getClass().getName().contains("RawImu") || //RawImu{timeUsec=2582049267, xacc=0, yacc=1, zacc=-997, xgyro=4, ygyro=3, zgyro=2, xmag=151, ymag=258, zmag=413, id=0, temperature=4499}
                        message2.getPayload().getClass().getName().contains("ScaledImu2") || //payload=ScaledImu2{timeBootMs=3097547, xacc=4, yacc=0, zacc=-1001, xgyro=-1, ygyro=0, zgyro=0, xmag=119, ymag=274, zmag=413, temperature=4499}
                        ...
                        message2.getPayload().getClass().getName().contains("EscTelemetry1To4"))//EscTelemetry1To4{temperature=[B@553a3d88, voltage=[0, 0, 0, 0], current=[0, 0,
                {
                } else if (message2.getPayload().getClass().getName().contains("GlobalPositionInt") ||
                    ...
                    } else if (message2.getPayload().getClass().getName().contains("NavControllerOutput")) {
                    ...
                    } else if (message2.getPayload().getClass().getName().contains("Attitude")) {
                    ...
                    if (message2.getPayload() instanceof Statustext) {
    ...
    public String camera() {
        ...
        try {
            ...
            //CameraInformation cameraInformation = CameraInformation.builder().camDefinitionUri("rtsp://172.20.14.87:8554/myrtsp2").flags(VideoStreamStatusFlags.VIDEO_STREAM_STATUS_FLAGS_RUNNING).build();

            //   connection.send2(systemId, componentId, cameraInformation);
//            connection.send2(systemId, componentId, new CommandLong.Builder().command(MavCmd.MAV_CMD_GET_HOME_POSITION).build(), linkId, timestamp, secretKey);
            MissionCount count = MissionCount.builder().count(4).targetComponent(100).targetSystem(1).missionType(MavMissionType.MAV_MISSION_TYPE_MISSION).build();
            connection.send2(systemId, componentId, count);
            // connection.send2(systemId, componentId, heartbeat);
...
//                                .build(), linkId, timestamp, secretKey);
            ...
            MissionItemInt missionItemInt3 = new MissionItemInt.Builder()
...
//                                .build(), linkId, timestamp, secretKey);
                ...
                if (message instanceof Mavlink2Message) {
                    ...
                    if (
                        ...
                        if( message.getPayload() instanceof MissionRequest && flag == 0){
                            ...
                            connection.send2(systemId, componentId, missionItemInt0);
                            flag++;
                        } else if( message.getPayload() instanceof MissionRequest && flag == 1){
                            connection.send2(systemId, componentId, missionItemInt1);
                            flag++;
                        } else if( message.getPayload() instanceof MissionRequest && flag == 2){
                            connection.send2(systemId, componentId, missionItemInt2);
                            flag++;
                        } else if( message.getPayload() instanceof MissionRequest && flag == 3){
                            connection.send2(systemId, componentId, missionItemInt3);
                            flag++;
    ...
    public String gimbal() {
        ...
        try {
            ...
            connection.send2(systemId,componentId,new CommandLong.Builder().command(MavCmd.MAV_CMD_REQUEST_MESSAGE).param1(280).param7(1).build());
