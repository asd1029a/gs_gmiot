...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
   ...
   <style>
	...
	#roadviewControl {position:absolute;top:5px;left:5px;width:42px;height:42px;z-index: 1;cursor: pointer; background:url('../../images/icons/mapBtn/btn_roadview.png') no-repeat center center}
	#roadviewControl.active {position:absolute;top:5px;left:5px;width:42px;height:42px;z-index: 1;cursor: pointer; background: url('../../images/icons/mapBtn/btn_roadview_active.png') no-repeat center center}
...
var mapCenter = new kakao.maps.LatLng(lat ,lon), // 지도의 중심좌표
...
if(mapTileType != 'base'){ 
	mapOption.mapTypeId = kakao.maps.MapTypeId.HYBRID
}
