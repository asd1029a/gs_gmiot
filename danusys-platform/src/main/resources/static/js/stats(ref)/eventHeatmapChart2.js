/**
 * 이벤트 heatmap chart 2 생성 관련 함수
 * @namespace eventHeatmapChart2
 * */

/**
 * 이벤트 heatmap chart 2 생성 함수
 * @function eventHeatmapChart2.blockChart2
 * */
function blockChart2() {
	...
	.post(JSON.stringify(jsonObj), function(error, data) {
		...
		svg.append('text').attr('text-anchor','middle')
			...
			.text($("#selectBarChart2Type option:selected").text()+"-행정동 발생건수 히트맵");
		svg.selectAll(".block")
