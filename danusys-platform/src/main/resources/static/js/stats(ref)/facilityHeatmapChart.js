/**
 * 시설물 heatmap chart 생성 관련 함수
 * @namespace facilityHeatmapChart
 * */

/**
 * 시설물 heatmap chart 생성 함수
 * @function facilityHeatmapChart.blockChart
 * */
function blockChart() {
	var jsonObj = {};
	...
	d3.json("/selectHeatMap/"+query+"/action")
		...
		svg.append('text').attr('text-anchor','middle')
			...
			.text($("#selectBarChartType option:selected").text()+"-용도별 장애건수 히트맵");
		svg.selectAll(".block")
