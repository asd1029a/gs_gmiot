...
(function (factory) {
  ...
  function init(input, settings) {
    ...
    if(settings.format === 'rgb') {
      ...
      size = settings.keywords ? '11' : settings.keywords;
    }
  ...
  function updateFromInput(input, preserveInputValue) {
    ...
    if(isRgb(input.val())) {
      // If input value is a rgb(a) string, convert it to hex color and update
		// opacity
  ...
  $([document])
   ...
   /*// Handle mouseup
    .on('mouseup.minicolors-grid-inner touchend.minicolors-grid-inner', function(e) {
   		debugger
    })*/
